export default function FormField({
  ...
  const baseClasses =
    "w-full min-w-0 rounded border bg-[var(--color-white)] px-3.5 py-2.5 text-[0.82rem] text-[var(--color-ink-dark)] outline-none transition-colors duration-200 placeholder:text-[var(--color-muted)] sm:px-4 sm:py-3 sm:text-[0.9rem]";
